...
const Financial = () => {
  return (
    ...
    <div className="re">
      ...
      <div className="ct">
        <h1>Podcaster<br /><span>Host</span> <br /></h1>
        <p className="pc">
        <IoBagHandle /> Job Type : Part-time<br/>
        <FaLocationDot /> Coimbatore<br/>
        <MdCurrencyRupee />5-10 LPA<br/>
        <LuFileSpreadsheet /> Experience: 2+ years<br/></p>
